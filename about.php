      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Online Food Delivery System <span></span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Shubham Bharadwaj</h2><p>CE084 <a href="" target="_blank">@shubhambharadwaj</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row" style="padding-left: 380px;">
          ...
          <div class="col-xl-3 col-lg-6 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="img/profilePic.jpg" class="img-fluid" alt="" style="height: 198px;width: 198px;">
          ...
          <div class="col-xl-3 col-lg-6 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="img/person-2.jpg" class="img-fluid" alt=""  style="height: 198px;width: 198px;">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Shubham Bharadwaj</h4>
                </div>
                <div class="social">
